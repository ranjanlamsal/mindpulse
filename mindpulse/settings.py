"""
Django settings for mindpulse project.
Optimized for production-ready deployment with proper security and performance settings.
"""
...
SECRET_KEY = os.getenv(
    'SECRET_KEY', 
    'django-insecure-b4%n4wo*jof)9oo7yxig7_fh&2y3fn9s3b2oj7m09%s9ob2v&z'  # Default for development only
)
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'mindpulse.log',
